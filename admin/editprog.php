...
<!-- Formulario Editar -->
            ...
            <form action="updprog.php" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                <label for="code">Codigo de Programa:</label>
                <input type="number" class="form-control" name="code" placeholder="Numérico" required> 
                 ...
                 <div class="form-group">
                    ...
                    <textarea placeholder="Descripción" rows="7" size="50" name="programa" class="form-control"></textarea>
                 </div>
                 <center>
...
<!-- Formulario Eliminar -->
              ...
              <form action="delprog.php" method="POST">
              <div class="form-group">
              <label for="code">Codigo de Programa:</label>
              <input type="number" class="form-control" name="code" placeholder="Numérico" required> 
              </div><center>
