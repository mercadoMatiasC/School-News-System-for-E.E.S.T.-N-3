 ...
 ?>
     ...
     <div class="ttl">
      ...
      <div class="col-sm-4" style="height:350px; background: white; margin-top: 40px; margin-bottom: 100px; border: #141414 3px solid;">
        <br><br>
        <h1 class="ndh">¡Noticia Modificada!</h1>
        <br><br>
...
mysqli_query($conexion, "UPDATE noticias set titulo='$titulo' where id_noticia='$code'") or die ("Error al intentar borrar");

mysqli_query($conexion, "UPDATE noticias set noticia='$noticia' where id_noticia='$code'") or die ("Error al intentar borrar");

$e=mysqli_error($conexion);

 echo "<b>Titulo:</b> ".$titulo.". <br><br>
       <b>Noticia:</b> ".$noticia.". <br><br>
       <br><br>"
?>
