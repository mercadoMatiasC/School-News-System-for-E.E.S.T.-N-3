 ...
 ?>
     ...
     <div class="ttl">
      ...
      <div class="col-sm-4" style="height:350px; background: white; margin-top: 40px; margin-bottom: 100px; border: #141414 3px solid;">
        <br><br>
        <h1 class="ndh">¡Programa Modificado!</h1>
        <br><br>
...
mysqli_query($conexion, "UPDATE programa set titulo='$titulo' where id_programa='$code'") or die ("Error al intentar borrar");
mysqli_query($conexion, "UPDATE programa set programa='$programa' where id_programa='$code'") or die ("Error al intentar borrar");

$e=mysqli_error($conexion);

 echo "<b>Titulo:</b> ".$titulo.". <br><br>
       <b>Programa:</b> ".$programa.". <br><br>
       <br><br>"
?>
