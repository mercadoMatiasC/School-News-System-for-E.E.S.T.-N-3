 ...
 ?>
     ...
     <div class="ttl">
      ...
      <div class="col-sm-4" style="height:350px; background: white; margin-top: 40px; margin-bottom: 100px; border: #141414 3px solid;">
        <br><br>
        <h1 class="ndh">¡Programa Publicado!</h1>
        <br><br>
...
$inserta = "INSERT INTO programa (titulo)
 VALUES ('$titulo');";

if ($_FILES['programa']["error"] > 0)
  {
  echo "Error: " . $_FILES['programa']['error'] . "<br>";
  }
else
  {
  echo "<b>Titulo:</b> ".$titulo.".<br><br>";
  echo "Nombre: " . $_FILES['programa']['name'] . "<br>";
  echo "Tipo: " . $_FILES['programa']['type'] . "<br>";

move_uploaded_file($_FILES['programa']['tmp_name'],"subidas/" . $_FILES['programa']['name']);
}
